...
$.fn.jqPuzzleMedium = function (settings, texts) {

    // default settings
    var defaults = {

        rows: 6, 					// number of rows [3 ... 9]
        cols: 6,		 			// number of columns [3 ... 9]
        hole: 36,					// initial hole position [1 ... rows*columns]
        shuffle: false,				// initially show shuffled pieces [true|false]
        numbers: true,				// initially show numbers on pieces [true|false]
        language: 'en',				// language for gui elements [language code]
...
$.fn.jqPuzzleHard = function (settings, texts) {
    ...
    var defaults = {
        ...
        hole: 81,					// initial hole position [1 ... rows*columns]
        shuffle: false,				// initially show shuffled pieces [true|false]
...
$(document).ready(function () {
    ...
    $('img.jqPuzzleMedium').each(function () {
        ...
        // call the plugin
        $(this).jqPuzzleMedium(settings);
    });
});

$(document).ready(function () {

    $('img.jqPuzzleHard').each(function () {
